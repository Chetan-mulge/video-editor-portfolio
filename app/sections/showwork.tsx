        ...
        <FadeIn>
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg">
              Handpicked edits. <Link href="/works" className="text-white underline decoration-[#D4AF37] underline-offset-4 hover:text-[#D4AF37] transition">some of my videos →</Link>
            </p>
          </div>
        </FadeIn>
