...
export default function Contact() {
  return (
    // Added 'relative z-20' to force this section ABOVE the background net
        ...
        <FadeIn delay={0.2}>
          <div className="relative inline-block group">
            <a 
              ...
              className="relative z-10 inline-block text-4xl md:text-6xl font-bold text-white transition-all border-b-2 border-white/20 group-hover:border-[#D4AF37] group-hover:text-[#D4AF37] pb-4 mb-20"
            >
              mulge10chetan@gmail.com
            </a>
            {/* Glow effect behind the email */}
            <div className="absolute inset-0 bg-[#D4AF37] blur-[100px] opacity-0 group-hover:opacity-20 transition-opacity duration-500" />
          </div>
        </FadeIn>

        {/* Social Links - NOW BRIGHTER & VISIBLE */}
        <FadeIn delay={0.3}>
          {/* Added a glass container so links are always readable over the net */}
            ...
            {[
             ...
             // { name: "YouTube", url: "https://youtube.com" }
              ...
              <a
                ...
                // CHANGED: text-gray-500 -> text-white (Much brighter)
